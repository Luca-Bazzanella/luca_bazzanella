          ...
          <div className="animate-fade-in space-y-8 flex flex-col justify-center order-2 lg:order-1">
            ...
            <div className="flex gap-3 flex-wrap justify-start items-start" style={{ marginTop: '10px' }}>
              ...
              <Button
                variant="outline"
                size="lg"
                className="border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 hover:text-slate-900 rounded-lg font-medium transition-all duration-200 flex items-center justify-center w-12 h-12 p-0"
