      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="relative group">
            <img 
              src="/lovable-uploads/2eb21475-ef8c-4054-ab76-420edc702a76.png" 
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="relative group">
              <img 
                src="/lovable-uploads/8753dece-6e38-48a2-bd4a-63e561d3b76d.png" 
            ...
            <div className="relative group">
              <img 
                src="/lovable-uploads/b110177f-ef62-4148-98d1-7abe0ca70cea.png" 
        ...
        <Card className="glass-effect border-0 shadow-2xl">
          <div className="p-12">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                <img 
                  src="/lovable-uploads/23c7b670-139e-412c-a1d4-9e6a3bc94767.png"
