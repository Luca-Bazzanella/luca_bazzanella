                    ...
                    <a href={image.link} target="_blank" rel="noopener noreferrer" className="block h-full">
                      <div className="relative group/image overflow-hidden h-full min-h-full">
                        <img
                          src={image.src}
                          alt={image.alt}
                          className="w-full h-full min-h-full object-cover rounded-none md:rounded-2xl shadow-lg transition-all duration-700 ease-out group-hover/image:shadow-2xl group-hover/image:scale-105 object-[25%_75%]"
                        />
                        <div
                          className={
